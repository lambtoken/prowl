local stageMobItems = {
    -- Stage 1
    {
        ...
        { chance = 0.3, min = 1, max = 2 },
        -- Match 5
        { chance = 0.4, min = 2, max = 2 },
        -- Match 6
        { chance = 0.4, min = 2, max = 3 },
        -- Match 7 (boss)
        { chance = 0.5, min = 2, max = 3 },
    },
    ...
    -- Stage 2
    {
        ...
        { chance = 0.5, min = 1, max = 2 },
        -- Match 3
        { chance = 0.6, min = 1, max = 3 },
        -- Match 4
        { chance = 0.6, min = 2, max = 3 },
        -- Match 5
        { chance = 0.7, min = 2, max = 3 },
        -- Match 6
        { chance = 0.7, min = 2, max = 4 },
        -- Match 7 (boss)
        { chance = 0.8, min = 2, max = 4 },
    },
    ...
    -- Stage 3
    {
        ...
        { chance = 0.7, min = 2, max = 3 },
        -- Match 2
        { chance = 0.75, min = 2, max = 3 },
        -- Match 3
        { chance = 0.8, min = 2, max = 4 },
        -- Match 4
        { chance = 0.85, min = 3, max = 4 },
        -- Match 5
        { chance = 0.9, min = 3, max = 4 },
        -- Match 6
        { chance = 1, min = 3, max = 5 },
        -- Match 7 (boss)
        { chance = 1, min = 4, max = 5 },
    }
}
